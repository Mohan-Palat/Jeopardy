...
class App extends Component {
    ...
    return (
      <>
        ...
        <div className="score">
          <Route
            path="/(random|custom)/"
            component={() => <ScoreKeeper score={this.state.score} />}
          />
        </div>
        <div id="main">
          <div className="game-board">
            <Route
              path="/"
              exact
              component={() => <NewGame getCategoryIds={this.getCategoryIds} />}
            />
            <Route
              path="/"
              exact
              component={() => (
                <Link to="/custom-settings">
            ...
            <Route
              ...
              component={() => (
                <Gameboard
                  setClue={(e, clue) => this.setClue(e, clue)}
            ...
            {/* <Route
              ...
              exact
              component={() => <Search addSearch={this.addIDFromSearch} />}
            /> */}
            {/* <Route
              path="/custom-settings"
              exact
  ...
  setScore = (userInput) => {
    ...
    if (
      ...
      this.state.currentClue.answer.toLocaleLowerCase()
    ) {
